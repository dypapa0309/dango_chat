  ...
  const CONFIG = {
    waste: {
      ...
      cheer: {
        ...
        4: "거의 다 왔어요. 수거 주소와 층수, 추가 장비 여부를 넣어주세요.",
    ...
    install: {
      ...
      cheer: {
        ...
        4: "거의 다 왔어요. 설치 주소와 타공, 연결 작업 여부를 넣어주세요.",
    ...
    errand: {
      ...
      cheer: {
        ...
        4: "거의 다 왔어요. 이동 주소와 추가 요청을 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    organize: {
      ...
      cheer: {
        ...
        4: "거의 다 왔어요. 방문 주소와 추가 요청을 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    ac_clean: {
      ...
      cheer: {
        ...
        4: "거의 다 왔어요. 방문 주소와 분해 세척 여부를 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    appliance_clean: {
    ...
    interior: {
      ...
      cheer: {
        ...
        4: "거의 다 왔어요. 현장 주소와 실측, 추가 요청을 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    interior_help: {
      ...
      cheer: {
        ...
        4: "거의 다 왔어요. 현장 주소와 추가 요청을 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    pt: {
      ...
      cheer: {
        ...
        4: "거의 다 왔어요. 수업 지역과 방문 여부를 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    vocal: {
    ...
    tutor: {
      ...
      cheer: {
        ...
        2: "좋아요. 날짜와 희망 시간을 골라주세요.",
        3: "좋아요. 이제 하나씩 넣으면 돼요. 횟수와 방향을 넣어주세요.",
        4: "거의 다 왔어요. 수업 지역과 추가 요청을 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    counseling: {
      ...
      cheer: {
        ...
        2: "좋아요. 날짜와 희망 시간을 골라주세요.",
        3: "좋아요. 이제 하나씩 넣으면 돼요. 횟수와 방향을 넣어주세요.",
        4: "거의 다 왔어요. 상담 지역과 대면 여부를 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    marketing: {
      ...
      cheer: {
        ...
        4: "거의 다 왔어요. 희망 지역과 납품 형식을 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    }
  };
