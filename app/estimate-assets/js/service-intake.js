  ...
  const CONFIG = {
    waste: {
      ...
      cheer: {
        ...
        2: "좋아요. 수거 날짜와 시간을 골라주세요.",
        3: "좋아요. 수거 주소를 입력해주세요.",
        4: "거의 다 왔어요. 버릴 품목과 층수, 추가 장비 여부를 넣어주세요.",
    ...
    install: {
      ...
      cheer: {
        ...
        2: "좋아요. 설치 날짜와 시간을 골라주세요.",
        3: "좋아요. 설치 주소를 입력해주세요.",
        4: "거의 다 왔어요. 품목 수량과 타공, 연결 작업 여부를 넣어주세요.",
    ...
    errand: {
      ...
      cheer: {
        ...
        2: "좋아요. 날짜와 시간을 골라주세요.",
        3: "좋아요. 이동 주소를 입력해주세요.",
        4: "거의 다 왔어요. 물건 크기와 건수, 추가 요청을 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    organize: {
      ...
      cheer: {
        ...
        3: "좋아요. 방문 주소를 입력해주세요.",
        4: "거의 다 왔어요. 범위와 건수, 추가 요청을 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    ac_clean: {
    ...
    interior: {
      ...
      cheer: {
        ...
        2: "좋아요. 날짜와 희망 시간을 골라주세요.",
        3: "좋아요. 현장 주소를 입력해주세요.",
        4: "거의 다 왔어요. 공사 범위와 실측, 추가 요청을 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    interior_help: {
      ...
      cheer: {
        ...
        2: "좋아요. 날짜와 희망 시간을 골라주세요.",
        3: "좋아요. 현장 주소를 입력해주세요.",
        4: "거의 다 왔어요. 필요한 건수와 추가 요청을 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    pt: {
      ...
      cheer: {
        ...
        2: "좋아요. 날짜와 희망 시간을 골라주세요.",
        3: "좋아요. 수업 지역을 입력해주세요.",
        4: "거의 다 왔어요. 횟수와 방문 여부, 추가 요청을 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    vocal: {
    ...
    counseling: {
      ...
      cheer: {
        ...
        2: "좋아요. 날짜와 희망 시간을 골라주세요.",
        3: "좋아요. 상담 지역을 입력해주세요.",
        4: "거의 다 왔어요. 횟수와 대면 여부, 추가 요청을 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    marketing: {
      ...
      cheer: {
        ...
        2: "좋아요. 날짜와 희망 시간을 골라주세요.",
        3: "좋아요. 희망 지역을 입력해주세요.",
        4: "거의 다 왔어요. 건수와 납품 형식, 추가 요청을 넣어주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    }
  };
