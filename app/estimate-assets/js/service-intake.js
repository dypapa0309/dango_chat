(function () {
  ...
  const CONFIG = {
    waste: {
      ...
      cheer: {
        ...
        2: "좋아요. 버릴 품목과 층수, 추가 장비 여부를 넣어주세요.",
        3: "좋아요. 수거 날짜와 시간을 골라주세요.",
        4: "거의 다 왔어요. 수거 주소를 입력해주세요.",
    ...
    install: {
      ...
      cheer: {
        ...
        2: "좋아요. 품목 수량과 타공, 연결 작업 여부를 넣어주세요.",
        3: "좋아요. 설치 날짜와 시간을 골라주세요.",
        4: "거의 다 왔어요. 설치 주소를 입력해주세요.",
    ...
    errand: {
      ...
      cheer: {
        ...
        2: "좋아요. 물건 크기와 건수, 추가 요청을 넣어주세요.",
        3: "좋아요. 날짜와 시간을 골라주세요.",
        4: "거의 다 왔어요. 이동 주소를 입력해주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    organize: {
      ...
      cheer: {
        ...
        2: "좋아요. 범위와 건수, 추가 요청을 넣어주세요.",
        3: "좋아요. 방문 날짜와 시간을 골라주세요.",
        4: "거의 다 왔어요. 방문 주소를 입력해주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    ac_clean: {
    ...
    interior: {
      ...
      cheer: {
        ...
        2: "좋아요. 공사 범위와 실측, 추가 요청을 넣어주세요.",
        3: "좋아요. 날짜와 희망 시간을 골라주세요.",
        4: "거의 다 왔어요. 현장 주소를 입력해주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    interior_help: {
    ...
    pt: {
      ...
      cheer: {
        ...
        2: "좋아요. 횟수와 방문 여부, 추가 요청을 넣어주세요.",
        3: "좋아요. 날짜와 희망 시간을 골라주세요.",
        4: "거의 다 왔어요. 수업 지역을 입력해주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    vocal: {
    ...
    counseling: {
      ...
      cheer: {
        ...
        2: "좋아요. 횟수와 대면 여부, 추가 요청을 넣어주세요.",
        3: "좋아요. 날짜와 희망 시간을 골라주세요.",
        4: "거의 다 왔어요. 상담 지역을 입력해주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    },
    marketing: {
      ...
      cheer: {
        ...
        2: "좋아요. 건수와 납품 형식, 추가 요청을 넣어주세요.",
        3: "좋아요. 날짜와 희망 시간을 골라주세요.",
        4: "거의 다 왔어요. 희망 지역을 입력해주세요.",
        5: "좋아요. 이제 거의 끝났어요. 금액과 접수 내용을 확인하면 됩니다."
      }
    }
  };
  ...
  const GENERIC_SERVICE_CONFIG = {
    ...
    ac_clean: {
      categories: {
        wall: { label: "벽걸이 에어컨", base: 56000 },
        stand: { label: "스탠드 에어컨", base: 92000 },
        twoinone: { label: "2in1 에어컨", base: 139000 },
        system: { label: "시스템 에어컨", base: 82000 }
      },
      addressLabel: "방문 주소",
      quantityLabel: "청소 대수",
  ...
  function renderPrice() {
    ...
    if ($("#stickyPriceDetail")) {
      $("#stickyPriceDetail").textContent = "시장 평균 대비 18.3% 저렴";
    }
    if ($("#priceUnder")) {
      const guide = genericServiceConfig()?.priceGuide || "전체 결제 뒤 바로 주문을 만들고 배차 준비를 시작합니다.";
      $("#priceUnder").textContent = "시장 평균 대비 18.3% 저렴 · " + guide;
    }
    if ($("#summary")) {
  ...
  function showStep(step) {
    ...
    const wizardShell = document.querySelector('.wizard-stage-shell');
    if (wizardShell) {
      const top = wizardShell.getBoundingClientRect().top + window.pageYOffset - 8;
  ...
  function mountDetailSelectionUi() {
    ...
    if (!config) return;
    ensureDetailSelectionState();
    // step 2 is 세부내용 for all DETAIL_SELECTION_CONFIG services
    const detailStepNum = '2';
